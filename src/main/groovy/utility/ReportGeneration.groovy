...
// This report is generated by the plugin from mkolisnyk/cucumber-reports
// Generates all the necessary reports
...
// This report is generated by the plugin from damianszczepanik/cucumber-reporting
File reportOutputDirectory = new File('build/cucumber-reports')
List<String> jsonFiles = new ArrayList<>()
jsonFiles.add soureFilePath
Configuration configuration = new Configuration(reportOutputDirectory, 'Gradle-Groovy-Test Automation')

new ReportBuilder(jsonFiles, configuration).with {
    generateReports()
}